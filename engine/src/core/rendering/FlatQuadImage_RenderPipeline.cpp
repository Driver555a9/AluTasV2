...
namespace CoreEngine
{
    ...
    : m_shader_program(s_VERTEX_SHADER_CODE, s_FRAGMENT_SHADER_CODE, nullptr, Shader::ProvidedPointers::ARE_SOURCE_CODE), m_vbo(custom_quad.data(), custom_quad.size() * sizeof(GLfloat))
    {
    ...
    {
        m_vbo.SetNewData(custom_quad.data(), custom_quad.size() * sizeof(GLfloat));
    }
