#include "common/FrontCar_CameraController.h"
...
namespace AsphaltTas
{
    ...
    {
        const glm::vec3 car_pos = m_racer_state.GetPositionOpenGL_XYZ();
        const glm::quat car_rot = m_racer_state.GetRotationOpenGL_XYZ();
