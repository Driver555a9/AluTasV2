...
#pragma GCC diagnostic pop
  ...
  public:
    ...
    static CharType to_char_type(std::uint8_t x) noexcept
    {
        ...
        static_assert(
            std::is_trivially_default_constructible_v<CharType> &&
            std::is_trivially_copyable_v<CharType>,
            "CharType must be trivially default constructible and trivially copyable"
        );
        CharType result;
